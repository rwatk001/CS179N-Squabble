...
public class DataContainer : MonoBehaviour {
	...
	public static void AssignLevel() {
        ...
        level_1 = Random.Range (3, 9);
		level_2 = Random.Range (3, 9);
		while (level_2 == level_1) {
			level_2 = Random.Range (3, 9);
		}
		level_3 = Random.Range (3, 9);
		while (level_3 == level_1 || level_3 == level_2) {
			level_3 = Random.Range (3, 9);
		}
		level_4 = Random.Range (3, 9);
		while (level_4 == level_1 || level_4 == level_2 || level_4 == level_3) {
			level_4 = Random.Range (3, 9);
		}

        level_5 = Random.Range(3, 9);
		while (level_5 == level_1 || level_5 == level_2 || level_5 == level_3 || level_5 == level_4)
        {
            level_5 = Random.Range(3, 9);
        }
        level_6 = Random.Range(3, 9);
		while (level_6 == level_1 || level_6 == level_2 || level_6 == level_3 || level_6 == level_4 || level_6 == level_5)
        {
            level_6 = Random.Range(3, 9);
        }
	}
